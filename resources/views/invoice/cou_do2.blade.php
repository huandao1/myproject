        ...
        <ul class="aui-list aui-form-list">
            ...
            <li class="aui-list-item">
                <div class="aui-list-item-inner">
                    ...
                    <div class="aui-list-item-input">
                        <label class="aui-font-size-12 c9 aui-margin-r-15"><input class="aui-radio" type="radio" name="typeli" value="1" > 企业单位</label>
                        <label class="aui-font-size-12 c9"><input class="aui-radio be " type="radio" name="typeli" value="2" checked> 个人/非企业单位</label>
                    </div>
            ...
            <li class="aui-list-item  upadd">
                <div class="aui-list-item-inner">
                    ...
                    <div class="aui-list-item-input">
                        <input type="text" placeholder="填写发票抬头" name="TitleName" class="c9 aui-font-size-12 companyin" onfocus="getup_data(1)">
...
<div class="submitbox">
    ...
    <ul class="aui-list aui-form-list">
        ...
        <p class="aui-margin-t-15"><div class="aui-btn aui-btn-block w90 bebg" id="ensure" onclick="ensure()">确认提交</div></p>
    </ul>
</div>
...
<script type="text/javascript">
                        ...
                        for(var index in dt){
                            if (dt[index].TitleType==t){
                                ...
                                checkedStr +='<li class="aui-list-header upli" style="height:47px" onclick="selup(this)">'+
                                    '<p class="clearfix" style="color:#2196F3"  title="'+dt[index].TaxpayerNumber+'">'+dt[index].TitleName+'</p>'+
    ...
    $(document).ready(function() {
        ...
        $('input[type=radio][name=typeli]').change(function() {
            if (this.value == '1') {
                window.location.href="invoice_cou_do/"+amount;
            }
        });
