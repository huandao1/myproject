...
<head>
    ...
    <style type="text/css">
        ...
        .submitbox{position: fixed;bottom: 0;background: #fff;display: none;z-index: 999}
        .submitbox h4{text-align: center;color: #4D4D4D;height: 2rem;line-height: 2rem;font-size: 0.8rem;}
        .submitbox .aui-list-header{background: #fff!important;}
        .mask{position: fixed;top: 0;left: 0;width: 100%;height: 100%;background-color: rgba(0,0,0,0.6);z-index: 990;display: none}
        .aui-toast-content{
            font-size: 0.6rem
        }
        #addressin{ width:100%;height:100%;-webkit-overflow-scrolling:touch;overflow-y:scroll;
...
<div class="contain" id="maininfo">
        ...
        <ul class="aui-list aui-form-list">
            ...
            <li class="aui-list-item">
                <div class="aui-list-item-inner">
                    ...
                    <div class="aui-list-item-input">
                        <label class="aui-font-size-12 c9 aui-margin-r-15"><input class="aui-radio" type="radio" name="typeli" value="1" checked> 企业单位</label>
                        <label class="aui-font-size-12 c9"><input class="aui-radio be " type="radio" name="typeli" value="2"> 个人/非企业单位</label>
                    </div>
            ...
            <li class="aui-list-item  upadd">
                <div class="aui-list-item-inner">
                    ...
                    <div class="aui-list-item-input">
                        <input type="text" placeholder="填写发票抬头（点击选择发票抬头）" name="TitleName" class="c9 aui-font-size-12 companyin" onfocus="getup_data(1)">
                        <input type="text" placeholder="请填写个人姓名" name="TitleName" class="c9 aui-font-size-12 personin" onfocus="getup_data(2)" style="display: none">
                    </div>
                </div>
            </li>
            <div class="upbox__parent">
                <div class="upbox"></div>
            </div>
            ...
            <li class="aui-list-item company">
                <div class="aui-list-item-inner">
                    ...
                    <div class="aui-list-item-input" id="addressin">
                        <input type="text" placeholder="非必填" id="address" class="c9 aui-font-size-12" name="BusinessAddress">
                    </div>
                </div>
            </li>
            <li class="aui-list-item company">
            ...
            <li class="aui-list-item">
                <div class="aui-list-item-inner">
                    ...
                    <div class="aui-list-item-input">
                        <input type="text" placeholder="非必填" class="be aui-font-size-14" value="{{$amount}}元" name="InvoicePrice">
                    </div>
                </div>
            </li>
    ...
    <p class="aui-margin-t-15"><div class="aui-btn aui-btn-block w90 bebg" onclick="subpost()">保存</div></p>
</div>
<div class="submitbox">
    <h4>开具电子发票</h4>
    <ul class="aui-list aui-form-list">
        ...
        <p class="aui-margin-t-15"><div class="aui-btn aui-btn-block w90 bebg" id="ensure">确认提交</div></p>
    </ul>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var t=$("#address").val();
        $("#address").val("").focus().val(t);
        $('input[type=radio][name=typeli]').change(function() {
            if (this.value == '2') {
                window.location.href="invoice_do2/"+amount;
            }
